...
public class RollbackOfficesConfig {
    ...
    @Bean
    public Step rollbackOfficesStep(JobRepository jobRepository,
                                    PlatformTransactionManager platformTransactionManager){

        return new StepBuilder(KycBatchExecutiveConstants.ROLLBACK_OFFICES_TASK,jobRepository)
                .tasklet(rollbackOfficesTasklet(),platformTransactionManager)
                .build();
    }
